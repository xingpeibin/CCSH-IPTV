...
def process_channel_line(line):
    if  "#genre#" not in line and "#EXTINF:" not in line and "," in line and "://" in line:
        ...
        if len(channel_address) > 0 and channel_address not in combined_blacklist: # 判断当前源是否在blacklist中
            ...
            elif channel_name in cs_dictionary and check_url_existence(cs_lines, channel_address): #地方台-潮汕频道
...
version=formatted_time+",https://gitee.com/xingpeibin/zb/raw/master/ds.mp4"
